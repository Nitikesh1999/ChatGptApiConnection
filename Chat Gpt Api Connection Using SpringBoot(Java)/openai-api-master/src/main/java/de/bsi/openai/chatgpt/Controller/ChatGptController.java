package de.bsi.openai.chatgpt.Controller;

import de.bsi.openai.chatgpt.Request.RequestBody;
import de.bsi.openai.chatgpt.Response.ResponseBody;
...
import de.bsi.openai.DTO.FormInputDTO;
import de.bsi.openai.ChatGptConnectionApi.OpenAiApiClient;
import de.bsi.openai.ChatGptConnectionApi.OpenAiApiClient.OpenAiService;
...
public class ChatGptController {
	...
	private String chatWithGpt3(String message) throws Exception {
		var completion = RequestBody.defaultWith(message);
		var postBodyJson = jsonMapper.writeValueAsString(completion);
		var responseBody = client.postToOpenAiApi(postBodyJson, OpenAiService.GPT_3);
		var completionResponse = jsonMapper.readValue(responseBody, ResponseBody.class);
